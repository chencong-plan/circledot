...
import cc.ccoder.circledot.core.dal.mapper.IArticleMapper;
 ...
 */
@Service
public class ArticleRepositoryImpl extends ServiceImpl<IArticleMapper, Article> implements IArticleRepository {
}
